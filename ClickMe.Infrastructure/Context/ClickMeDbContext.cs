using ClickMe.Domain.Entities;
using Microsoft.EntityFrameworkCore;

namespace ClickMe.Infrastructure.Context;

public partial class ClickMeDbContext : DbContext {
    public ClickMeDbContext() { }

    public ClickMeDbContext(DbContextOptions<ClickMeDbContext> options) : base(options) { }
